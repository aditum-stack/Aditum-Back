...
CREATE TABLE community(
    ...
    `person_count` INTEGER(12) NOT NULL DEFAULT -1 COMMENT '社区用户总数',
...
ADD COLUMN `person_count` INTEGER(12) NOT NULL DEFAULT -1 COMMENT '社区用户总数' AFTER `device_online_count`;
