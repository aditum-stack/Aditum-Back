...
public class TheFullAnalysisBootstarp {
    ...
    public void runFullAnalysis() {
        ...
        CompletableFuture<Void> voidCompletableFuture4 = CompletableFuture.runAsync(this.analysorSix::analysis);
        CompletableFuture<Void> voidCompletableFuture5 = CompletableFuture.runAsync(this.analysorFour::analysis);
        CompletableFuture<Void> voidCompletableFuture6 = CompletableFuture.runAsync(this.analysorThree::analysis);
        ...
        CompletableFuture<Void> voidCompletableFuture11 = CompletableFuture.runAsync(this.accessAddressAnalyzer::analysis);
        CompletableFuture<Void> voidCompletableFuture12 = CompletableFuture.runAsync(this.accessIntervalAnalyzer::analysis);
        CompletableFuture<Void> voidCompletableFuture13 = CompletableFuture.runAsync(this.accessTimeAnalyzer::analysis);
